...
if [ ! -f "$CURRENT_STACK" ]; then
  ...
  aws cloudformation deploy --template-file $LAUNCHER_APP_DIR/fleetLauncherApp/base_template.yml --stack-name $STACK_NAME --capabilities CAPABILITY_NAMED_IAM --parameter-overrides SimulationApplicationS3Key=$S3_OUTPUT_KEY 
